        ...
        <nav>
          <ul>
            <li
              ...
              <Link to={
                  JSON.parse(localStorage.getItem("loginStatus")) === true ? "/dashboard" : "/" }>
            ...
            <li
              ...
              <Link to={
                  JSON.parse(localStorage.getItem("loginStatus")) === true ? "/products" : "/" }>
            ...
            <li className={
              ...
              <Link to={
                  JSON.parse(localStorage.getItem("loginStatus")) === true ? "/account" : "/" }>
